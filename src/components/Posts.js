...
class Posts extends Component {
    state = { 
        ...
        arrPosts: [     
            ...
            {userId: 2, id: 14, title: 'voluptatem eligendi optio', body: 'fuga et accusamus dolorum perferendis illo volupta…molestiae beatae\nsed aut voluptas totam sit illum'},
            ...
            {userId: 2, id: 20, title: 'doloribus ad provident suscipit at', body: 'qui consequuntur ducimus possimus quisquam amet si…erum consequatur expedita quidem cumque explicabo'},
            ...
            {userId: 3, id: 27, title: 'quasi id et eos tenetur aut quo autem', body: 'eum sed dolores ipsam sint possimus debitis occaec…atibus rerum sed inventore temporibus consequatur'},
            ...
            {userId: 4, id: 31, title: 'ullam ut quidem id aut vel consequuntur', body: 'debitis eius sed quibusdam non quis consectetur vi…sci atque\nquaerat voluptatem adipisci repudiandae'},
            ...
            {userId: 4, id: 37, title: 'provident vel ut sit ratione est', body: 'debitis et eaque non officia sed nesciunt pariatur…s omnis consequatur aut enim officiis in quam qui'},
            {userId: 4, id: 38, title: 'explicabo et eos deleniti nostrum ab id repellendus', body: 'animi esse sit aut sit nesciunt assumenda eum volu…t aut id quia\nratione optio eos iusto veniam iure'},
            ...
            {userId: 4, id: 40, title: 'enim quo cumque', body: 'ut voluptatum aliquid illo tenetur nemo sequi quo …e omnis voluptatem iure quasi maxime voluptas nam'},
            {userId: 5, id: 41, title: 'non est facere', body: 'molestias id nostrum\nexcepturi molestiae dolore om…s ex ut\nnam quidem est ducimus sunt debitis saepe'},
            {userId: 5, id: 42, title: 'commodi ullam sint et excepturi error explicabo praesentium voluptas', body: 'odio fugit voluptatum ducimus earum autem est inci…epellendus voluptates quia\nratione harum vitae ut'},
            ...
            {userId: 5, id: 47, title: 'quibusdam cumque rem aut deserunt', body: 'voluptatem assumenda ut qui ut cupiditate aut impe…erum ea iure soluta nostrum\neligendi et voluptate'},
            ...
            {userId: 5, id: 50, title: 'repellendus qui recusandae incidunt voluptates tenetur qui omnis exercitationem', body: 'error suscipit maxime adipisci consequuntur recusa…\nadipisci impedit sequi nesciunt quis consectetur'},
            ...
            {userId: 6, id: 55, title: 'sit vel voluptatem et non libero', body: 'debitis excepturi ea perferendis harum libero opti…\net ut incidunt omnis molestiae\nnihil ut eum odit'},
            ...
            {userId: 6, id: 59, title: 'qui commodi dolor at maiores et quis id accusantium', body: 'perspiciatis et quam ea autem temporibus non volup… quas et magni\net hic ut ut commodi expedita sunt'},
            ...
            {userId: 7, id: 69, title: 'fugiat quod pariatur odit minima', body: 'officiis error culpa consequatur modi asperiores e…s\nsequi commodi repudiandae asperiores et saepe a'},
            ...
            {userId: 8, id: 73, title: 'consequuntur deleniti eos quia temporibus ab aliquid at', body: 'voluptatem cumque tenetur consequatur expedita ips…t et\net in consequuntur voluptatem voluptates aut'},
            ...
            {userId: 8, id: 79, title: 'pariatur consequatur quia magnam autem omnis non amet', body: 'libero accusantium et et facere incidunt sit dolor… ducimus est\nofficiis esse molestiae iste et quos'},
            ...
            {userId: 9, id: 81, title: 'tempora rem veritatis voluptas quo dolores vero', body: 'facere qui nesciunt est voluptatum voluptatem nisi…tur\nex officiis minima doloremque voluptas ut aut'},
            ...
            {userId: 9, id: 83, title: 'odit et voluptates doloribus alias odio et', body: 'est molestiae facilis quis tempora numquam nihil q…i dolore numquam\nreprehenderit eius rem quibusdam'},
            ...
            {userId: 9, id: 86, title: 'placeat quia et porro iste', body: 'quasi excepturi consequatur iste autem temporibus …xplicabo autem\nasperiores pariatur deserunt optio'},
            ...
            {userId: 10, id: 92, title: 'ratione ex tenetur perferendis', body: 'aut et excepturi dicta laudantium sint rerum nihil…icia et similique libero et\ncommodi voluptate qui'},
            {userId: 10, id: 93, title: 'beatae soluta recusandae', body: 'dolorem quibusdam ducimus consequuntur dicta aut q…am\nsit error sed sunt eveniet provident qui nulla'},
            ...
            {userId: 10, id: 95, title: 'id minus libero illum nam ad officiis', body: 'earum voluptatem facere provident blanditiis velit…s\ncorporis cupiditate eaque assumenda ad nesciunt'},
            ...
            {userId: 10, id: 97, title: 'quas fugiat ut perspiciatis vero provident', body: 'eum non blanditiis soluta porro quibusdam voluptas…st et voluptatem dignissimos dolor itaque sit nam'},
    ...
    deletePost = (postId) => {
        this.setState({
          arrPosts: this.state.arrPosts.filter((el) => el.id !== postId),
        });
      };
      ...
      render() {
        const filteredPosts = this.state.arrPosts.filter((post) =>
          post.userId.toString().includes(this.state.filterId)
        );
